<template>
    <div class="keepAliveTable">
        ...
        <p><a href="https://github.com/u-leo/umy-ui/blob/master/examples/pages/u-table-component/virtualTableUsage/Tab1.vue" target="_blank">tab 1页面的代码</a></p>
        <p><a href="https://github.com/u-leo/umy-ui/blob/master/examples/pages/u-table-component/virtualTableUsage/Tab2.vue" target="_blank">tab 2页面的代码</a></p>
